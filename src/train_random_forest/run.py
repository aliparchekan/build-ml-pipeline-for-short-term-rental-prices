...
def go(args):
    ...
    mlflow.sklearn.save_model(sk_pipe, "random_forest_dir", input_example=X_val.iloc[:2])
    ######################################
    ...
    artifact = wandb.Artifact(name=args.output_artifact, type="model_export", description="trained model", metadata=rf_config)
